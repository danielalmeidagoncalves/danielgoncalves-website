    ...
    render: function() {
      return (
        <div id="acknowledgements" className="ui container">
          <div className="ui horizontal inverted small divided link">
              ...
              <div className="ui grid">
                <div className="row">
                  ...
                  <div className="five wide column">
                    <a href="//www.hotjar.com/?utm_source=badge" className="hotjar-badge"><img src="//static.hotjar.com/b/hotjar-badge-light.png" alt="Hotjar - Unlimited insights from your web and mobile sites" /></a>          </div>
                  </div>
                  </div>
                </div>
          </div>
